    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0B1F33] to-[#145B8C] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          <h1 className="text-2xl font-bold text-[#0B1F33] mb-1">Nouveau mot de passe</h1>
          <p className="text-gray-500 text-sm mb-6">Au moins 8 caractères, une majuscule, une minuscule et un chiffre.</p>
