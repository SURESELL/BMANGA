  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-5 flex items-center gap-4">
        <div className="w-14 h-14 rounded-full bg-[#145B8C] flex items-center justify-center text-white text-2xl font-bold shrink-0">
      ...
      <form onSubmit={handleUpdate} className="bg-white border border-gray-200 rounded-xl p-6 space-y-4">
        <div className="flex items-center gap-2 mb-1">
          <User className="w-5 h-5 text-[#145B8C]" />
        ...
        <button
          type="submit"
          disabled={loading}
          className="bg-[#145B8C] text-white px-6 py-2.5 rounded-lg text-sm font-medium hover:bg-[#0B1F33] transition-colors disabled:opacity-60"
        >
